                  ...
                  <tbody className="bg-white">
                    <tr>
                      ...
                      <td className="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                        <textarea
                          className="text-sm leading-5 text-gray-900 w-full border"
                          {...register(`sections.0.texts.0.content.${lang}`)}
                        ></textarea>
                      </td>
                      <td className="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                        <textarea
                          className="text-sm leading-5 text-gray-900 w-full border"
                          {...register(`sections.0.texts.1.content.${lang}`)}
                        ></textarea>
                      </td>
                      <td className="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                        <textarea
                          className="text-sm leading-5 text-gray-900 w-full border"
                          {...register(`sections.0.texts.2.content.${lang}`)}
                        ></textarea>
                      </td>
                      <td className="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                        <textarea
                          className="text-sm leading-5 text-gray-900 w-full border"
                          {...register(`sections.0.texts.3.content.${lang}`)}
                        ></textarea>
                      </td>
                    </tr>
                  </tbody>
                  ...
                  <tbody className="bg-white">
                    <tr>
                      ...
                      <td className="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                        <textarea
                          className="text-sm leading-5 text-gray-900 border w-full"
                          {...register(`sections.1.texts.0.content.${lang}`)}
                        ></textarea>
                      </td>
                      <td className="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                        <Controller
